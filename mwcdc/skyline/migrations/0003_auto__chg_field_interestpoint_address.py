...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InterestPoint.address'
        db.alter_column(u'skyline_interestpoint', 'address', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'InterestPoint.address'
        db.alter_column(u'skyline_interestpoint', 'address', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'skyline.interestpointmapping': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'viewpoints_map'", 'to': u"orm['skyline.InterestPoint']"}),
