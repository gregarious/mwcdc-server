...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.twitter_handle'
        db.alter_column(u'places_place', 'twitter_handle', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Place.fb_id'
        db.alter_column(u'places_place', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Place.twitter_handle'
        db.alter_column(u'places_place', 'twitter_handle', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Place.fb_id'
        db.alter_column(u'places_place', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=20))
